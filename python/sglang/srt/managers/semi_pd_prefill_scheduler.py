    ...
    def get_next_batch_to_run(self) -> Optional[ScheduleBatch]:
        ...
        try:
            if getattr(self, 'pp_rank', 0) != 0:
                ...
                # 🔧 FIX: Remove incorrect multimodal_inputs clearing logic
                # VLM models need multimodal_inputs (especially mrope_positions) in all chunks
                # Clearing multimodal_inputs causes generation to fail or produce incorrect output
                # Original SGLang does not have this logic - this was incorrectly added
                #
                # REMOVED (行 448-459):
