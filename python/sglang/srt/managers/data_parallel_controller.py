    ...
    def launch_dp_schedulers(self, server_args: ServerArgs, port_args: PortArgs):
        ...
        for dp_rank in range(server_args.dp_size):
            ...
            if self.server_args.enable_semi_pd:
                target = self.launch_semi_pd_tensor_parallel_group_thread
...
def run_data_parallel_controller_process(
    ...
    def launch_semi_pd_tensor_parallel_group_thread(
        self,
        server_args: ServerArgs,
        port_args: SemiPDPortArgs,
        base_gpu_id: int,
        ...
        try:
            ...
            traceback = get_exception_traceback()
            logger.error(f"launch_semi_pd_tensor_parallel_group_thread hit an exception: {traceback}")
